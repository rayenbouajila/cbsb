...
def register(
    ...
    email_verified passe automatiquement a True lorsque l'admin approuve le compte."""
...
def login(payload: schemas.LoginRequest, db: Session = Depends(get_db)):
    ...
    if not user.email_verified:
        raise HTTPException(status_code=403, detail="Compte non valide par l'administrateur")
